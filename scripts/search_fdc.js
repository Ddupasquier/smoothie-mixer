// Node.js script to search the FDC API for a keyword and print item names
// Usage: node scripts/search_fdc.js milk
...
if (!query) {
  console.error('Usage: node scripts/search_fdc.js <keyword>');
  process.exit(1);
}
